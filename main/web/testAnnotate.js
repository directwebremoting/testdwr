...
function testAnnotateBooleanParam() {
  runAnnotateComparisonTests([
...
function testAnnotateShortParam() {
  runAnnotateComparisonTests([
...
function testAnnotateLongParam() {
  runAnnotateComparisonTests([
...
function testAnnotateFloatParam() {
  runAnnotateComparisonTests([
...
function testAnnotateDoubleParam() {
  runAnnotateComparisonTests([
...
function testAnnotateCharParam() {
  runAnnotateComparisonTests([
...
function testAnnotateStringParam() {
  runAnnotateComparisonTests([
